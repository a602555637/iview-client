  ...
  <div>
    ...
    >
      <Form :model="localItem" :label-width="80" :rules="ruleValidate" ref="table">
        <FormItem label="资源名称">
          <Input v-model="localItem.name" placeholder="请输入资源名称" prop="name" />
        </FormItem>
        <FormItem label="资源路径">
          <Input v-model="localItem.path" placeholder="请输入资源路径" prop="path" />
        </FormItem>
         <FormItem label="请求类型">
        ...
        <FormItem label="资源描述">
          <Input v-model="localItem.regmark" placeholder="请输入资源描述" />
        </FormItem>
      </Form>
    </Modal>
  </div>
