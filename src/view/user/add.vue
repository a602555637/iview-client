  ...
  <div>
    ...
    >
      <Form :model="localItem" :label-width="80" :rules="ruleValidate" ref="table">
        <FormItem label="登录名">
          <Input prefix="md-mail" v-model="localItem.username" placeholder="请输入用户名" prop="username" />
        </FormItem>
        <FormItem label="密码">
          <Input prefix="md-lock" v-model="localItem.password" placeholder="请输入密码" prop="password" />
        </FormItem>
        <FormItem label="用户昵称">
          <Input prefix="md-person" v-model="localItem.name" placeholder="请输入用户昵称" prop="name" />
        </FormItem>
        <FormItem label="手机号码">
          <Input v-model="localItem.mobile" placeholder="请输入手机号码" prop="mobile" />
        </FormItem>
        <FormItem label="是否禁用">
